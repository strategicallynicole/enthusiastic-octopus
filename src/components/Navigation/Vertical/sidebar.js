...
export default function Sidebar() {
    ...
    return (
        <>
            <div onClick={() => SetsidebarMobile(!sidebarMobile)} className="absolute inset-0 flex items-center justify-center w-8 h-8 m-auto mt-4 ml-0 bg-gray-800 cursor-pointer rounded-r-md md:mt-6 lg:hidden">
            ...
            <div onClick={() => Setsidebar(!sidebar)} className="absolute inset-0 flex items-center justify-center hidden w-8 h-8 m-auto mt-4 ml-0 bg-gray-800 cursor-pointer rounded-r-md md:mt-6 lg:block">
                ...
                <div id="sidebar" className={sidebar ? "hidden" : "fixed lg:sticky h-full  min-h-screen  z-40 top-0 bg-gray-800 py-7 w-64"}>
                    <div className="px-7">
                        <div className="flex items-center justify-between">
                            ...
                            <div onClick={() => Setsidebar(!sidebar)} className="ml-8 text-gray-700 cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 20 20" fill="none">
                                    <path d="M3.33337 6.66667H16.6667" stroke="#A0AEC0" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M3.33337 13.3332H16.6667" stroke="#A0AEC0" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                        ...
                        <div className="mt-16">
                            <a href="javascript:void(0)">
                                <div className="flex items-center cursor-pointer">
                                    <div className="px-1 py-1 bg-white rounded-sm">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 20 20" fill="none">
                            ...
                            <a href="javascript:void(0)">
                                <div className="flex items-center mt-5 cursor-pointer">
                                    <div className="px-1 py-1 text-gray-500 duration-150 ease-in bg-transparent rounded-sm hover:bg-white hover:text-gray-800">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 20 20" fill="none">
                                    ...
                                    <p className="ml-2 text-sm font-normal text-gray-400 duration-150 ease-in hover:text-white">Sales</p>
                                </div>
                            </a>
                            <a href="javascript:void(0)">
                                <div className="flex items-center mt-5 cursor-pointer">
                                    ...
                                    <p className="ml-2 text-sm font-normal text-gray-400 duration-150 ease-in hover:text-white">Analytics</p>
                                </div>
                            </a>
                            <a href="javascript:void(0)">
                                <div className="flex items-center mt-5 cursor-pointer">
                                    ...
                                    <p className="ml-2 text-sm font-normal text-gray-400 duration-150 ease-in hover:text-white">Calendar</p>
                                </div>
                            </a>
                        </div>
                    </div>
                ...
                <div id="sidebarMob" className={sidebarMobile ? "fixed lg:sticky h-full z-40 top-0 bg-gray-800 py-7 w-64 min-h-screen" : "hidden"}>
                    <div className="px-7">
                        <div className="flex items-center justify-between">
                            ...
                            <div onClick={() => SetsidebarMobile(!sidebarMobile)} className="ml-8 text-gray-700 cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 20 20" fill="none">
                                    <path d="M3.33337 6.66667H16.6667" stroke="#A0AEC0" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M3.33337 13.3332H16.6667" stroke="#A0AEC0" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
