    ...
    return (
        <div>
            ...
            <div className="flex flex-no-wrap">
                <div className="absolute z-20 h-full p-4 bg-gray-100 border-r border-gray-100 sm:relative">
                    <div className="flex w-full">
                        <div className="flex flex-col justify-center w-1/4 ">
                            <div className="cursor-pointer" onClick={() => setShow(!show)}>
                                <svg xmlns="http://www.w3.org/2000/svg" className="mt-1 cursor-pointer icon icon-tabler icon-tabler-menu-2" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="#718096" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <ul aria-orientation="vertical" className="py-8 rounded">
                                <li className="pt-4 text-sm leading-3 tracking-normal text-indigo-700 cursor-pointer hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                    <div className="">
                                ...
                                <li className="flex items-center pt-2 mt-6 text-sm leading-3 tracking-normal text-gray-600 cursor-pointer hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                        ...
                        <div className={show ? "w-3/4 flex justify-start flex-col pr-12 transition duration-150 ease-in-out hidden" : "w-3/4 flex justify-start flex-col pr-12 transition duration-150 ease-in-out"}>
                            <div className="mt-2">
                            ...
                            <ul aria-orientation="vertical" className="py-8 rounded">
                                <li className="py-2 text-sm leading-3 tracking-normal text-indigo-700 cursor-pointer hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                    <span className="ml-2">Dashboard</span>
                                </li>
                                <li className="flex items-center py-2 mt-6 text-sm leading-3 tracking-normal text-gray-600 cursor-pointer hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
