        ...
        <>
            <div className="w-full h-full bg-gray-200">
                    ...
                    <div className="container px-6 mx-auto md:py-2 xl:py-0">
                        <div className="flex items-center justify-between">
                            <div className="inset-y-0 left-0 flex items-center bg-transparent outline-none">
                                <div className="inline-flex items-center justify-center text-gray-400 transition duration-150 ease-in-out rounded-md cursor-pointer hover:text-white focus:outline-none">
                                    <div className="text-gray-400 cursor-pointer xl:hidden sm:mr-10 hover:text-white focus:outline-none">
                                        <ul className="absolute left-0 right-0 hidden p-2 mt-12 bg-white border-r rounded shadow md:mt-16">
                                            ...
                                            <li className="flex flex-col justify-center py-2 text-sm leading-3 tracking-normal text-gray-600 cursor-pointer md:hidden hover:text-indigo-700 focus:text-indigo-700 focus:outline-none" onclick="dropdownHandler(this)">
                                                ...
                                                <ul className="hidden mt-1 ml-2">
                                                    <li className="px-3 py-2 text-xs font-normal leading-3 tracking-normal text-gray-600 cursor-pointer hover:bg-indigo-700 hover:text-white">Landing Pages</li>
                                                    <li className="px-3 py-2 text-xs font-normal leading-3 tracking-normal text-gray-600 cursor-pointer hover:bg-indigo-700 hover:text-white">Templates</li>
                                                    <li className="px-3 pt-2 text-xs font-normal leading-3 tracking-normal text-gray-600 cursor-pointer hover:bg-indigo-700 hover:text-white">Components</li>
                                                </ul>
                                            </li>
                                            <li className="flex items-center pt-2 pb-4 text-sm leading-3 tracking-normal text-gray-600 border-b border-gray-300 cursor-pointer md:hidden hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                        ...
                                        <div className="p-2 bg-gray-700 border border-gray-300 rounded-full">
                                            ...
                                            <div className="hidden close-m-menu" onclick="MenuHandler(this,false)">
                                ...
                                <div className="items-center justify-center hidden md:flex sm:items-stretch sm:justify-start">
                                    <div className="hidden md:flex">
                                        ...
                                        <a className="relative flex py-6 mx-10 text-sm leading-5 text-gray-800 transition duration-150 ease-in-out cursor-pointer hover:text-indigo-700 focus:outline-none focus:text-indigo-700" onClick={() => setProduct(!product)}>
                                            Products
                                            <span className="pl-2">
                                            ...
                                            {product && (
                                                <ul className="absolute left-0 w-32 py-1 mt-2 mt-12 -ml-4 bg-white rounded shadow ">
                            ...
                            <div className="items-center justify-end hidden xl:flex">
                                ...
                                <div className="relative ml-6">
                                    <div className="flex items-center">
                                        ...
                                        <div className="relative text-gray-800 sm:ml-2" onClick={() => setProfile(!profile)}>
                                            <svg xmlns="http://www.w3.org/2000/svg" className="cursor-pointer icon icon-tabler icon-tabler-chevron-down" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" />
                                                <polyline points="6 9 12 15 18 9" />
                                            </svg>
                ...
                <nav>
                    ...
                    <div className={show ? "xl:hidden w-full h-full absolute z-40  transform  translate-x-0 " : "   xl:hidden w-full h-full absolute z-40  transform -translate-x-full"}>
                                        ...
                                        <div className="flex items-center justify-between w-full mt-6">
                                            <div className="flex items-center justify-between w-full">
                                                <div className="flex items-center">
                                                    ...
                                                    <p className="ml-3 text-base text-gray-800 md:text-2xl">The North</p>
                                                </div>
