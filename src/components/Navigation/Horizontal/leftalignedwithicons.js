    ...
    return (
        <>
            <div className="w-full h-full bg-gray-200">
                {/* Code block starts */}
                <nav className="hidden w-full bg-white shadow xl:block">
                    <div className="container flex items-center justify-between h-16 px-6 mx-auto lg:items-stretch">
                        <div className="flex items-center">
                            <div className="flex items-center mr-10">
                                ...
                                <h3 className="hidden ml-3 text-base font-bold leading-tight tracking-normal text-gray-800 lg:block">The North</h3>
                            </div>
                            <ul className="items-center hidden h-full xl:flex">
                                ...
                                <li className="flex items-center h-full mx-10 text-sm tracking-normal text-gray-800 transition duration-150 ease-in-out cursor-pointer hover:text-indigo-700">
                                    <span className="mr-2">
                                ...
                                <li className="flex items-center h-full mr-10 text-sm tracking-normal text-gray-800 transition duration-150 ease-in-out cursor-pointer hover:text-indigo-700">
                                    <span className="mr-2">
                                ...
                                <li className="flex items-center h-full text-sm tracking-normal text-gray-800 transition duration-150 ease-in-out cursor-pointer hover:text-indigo-700">
                                    <span className="mr-2">
                        ...
                        <div className="items-center justify-end hidden h-full xl:flex">
                            <div className="flex h-full">
                                <div className="flex items-center justify-center h-full px-6 text-gray-400 border-l border-gray-300">
                                ...
                                <div className="flex items-center justify-center w-20 h-full text-gray-400 border-l border-r border-gray-300">
                                ...
                                <div className="flex items-center justify-center w-20 h-full text-gray-400 border-r border-gray-300 cursor-pointer">
                                ...
                                <div className="flex flex-col justify-between w-full h-full">
                                    <div>
                                        ...
                                        <ul className="f-m-m">
                                                ...
                                                <li className="pt-8 text-gray-800">
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex items-center">
                                                            ...
                                                            <p className="ml-3 text-base text-gray-800 xl:text-base md:text-2xl">Products</p>
                                                        </div>
                                                    </div>
                                                </li>
                                            </a>
                                            ...
                                            <li className="pt-8 text-gray-800 cursor-pointer">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center">
                                                        <div className="w-6 h-6 text-gray-800 md:w-8 md:h-8">
                                                        ...
                                                        <p className="ml-3 text-base text-gray-800 xl:text-base md:text-2xl">Deliverables</p>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
