    ...
    return (
        <>
            <div classname="w-full h-full bg-gray-200">
                <nav className="hidden w-full mx-auto bg-gray-800 shadow xl:block">
                    <div className="container flex items-center justify-between h-16 px-6 mx-auto lg:items-stretch">
                        <div className="flex items-center">
                            <div className="flex items-center mr-10">
                                ...
                                <h3 className="hidden ml-3 text-base font-bold leading-tight tracking-normal text-white xl:block">The North</h3>
                            </div>
                            <ul className="items-center hidden h-full pr-32 xl:flex">
                                <li className="flex items-center h-full text-sm tracking-normal text-indigo-700 cursor-pointer">Dashboard</li>
                                <li className="relative flex items-center h-full mx-10 text-sm tracking-normal text-white transition duration-150 ease-in-out cursor-pointer hover:text-indigo-700" onClick={() => setProduct(!product)}>
                                    {product && (
                                        <ul className="absolute top-0 left-0 w-32 py-1 mt-16 -ml-4 bg-white rounded shadow">
                                ...
                                <li className="flex items-center h-full mr-10 text-sm tracking-normal text-white transition duration-150 ease-in-out cursor-pointer hover:text-indigo-700">Performance</li>
                                <li className="relative flex items-center h-full text-sm tracking-normal text-white transition duration-150 ease-in-out cursor-pointer hover:text-indigo-700" onClick={() => setDeliverables(!deliverables)}>
                                    {deliverables && (
                                        <ul className="absolute top-0 left-0 w-32 py-1 mt-16 -ml-4 bg-white rounded shadow">
                                            <li className="px-3 py-3 text-sm font-normal leading-3 tracking-normal text-gray-600 cursor-pointer hover:bg-indigo-700 hover:text-white">Landing Pages</li>
                                            <li className="px-3 py-3 text-sm font-normal leading-3 tracking-normal text-gray-600 cursor-pointer hover:bg-indigo-700 hover:text-white">Templates</li>
                        ...
                        <div className="items-center justify-end hidden h-full xl:flex">
                            <div className="flex items-center h-full">
                                <div className="flex items-center justify-end w-32 h-full pr-16 border-r border-gray-700" />
                                <div className="flex w-full h-full">
                                    <div className="flex items-center justify-center w-32 h-full text-gray-400 border-r border-gray-700 cursor-pointer">
                                    ...
                                    <div className="relative flex items-center justify-end w-full cursor-pointer" onClick={() => setProfile(!profile)}>
                                        {profile && (
                                        ...
                                        <img className="object-cover w-10 h-10 rounded-full" src="https://tuk-cdn.s3.amazonaws.com/assets/components/horizontal_navigation/hn_2.png" alt="logo" />
                ...
                {/* Navbar */}
                <nav>
                    <div className="fixed top-0 z-0 flex items-center justify-between w-full px-6 py-4 bg-gray-800 xl:hidden">
                        <div className="w-24">
                                                    ...
                                                    {product && (
                                                        <div>
                                                            <ul className="my-3">
                                                                ...
                                                                <li className="px-6 py-2 text-base text-white xl:text-base md:text-2xl hover:text-indigo-500">Out of Stock</li>
                                                                <li className="px-6 py-2 text-base text-white xl:text-base md:text-2xl hover:text-indigo-500">New Products</li>
                                                            </ul>
                                                        </div>
                                                    )}
                                                </li>
