                    ...
                    <div className="container px-6 py-2 mx-auto xl:py-0">
                        <div className="flex items-center justify-between">
                            <div className="inset-y-0 left-0 flex items-center xl:hidden">
                                <div className="inline-flex items-center justify-center p-2 text-gray-700 transition duration-150 ease-in-out rounded-md hover:text-gray-100 focus:outline-none">
                                    <div className="visible xl:hidden">
                                        <ul className="absolute left-0 right-0 hidden p-2 mt-8 bg-white border-r rounded shadow md:mt-8">
                                            ...
                                            <li className="flex flex-col justify-center py-2 text-sm leading-3 tracking-normal text-gray-600 cursor-pointer xl:hidden hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                                <div className="flex items-center">
                                            ...
                                            <li className="flex items-center py-2 text-sm leading-3 tracking-normal text-gray-600 cursor-pointer xl:hidden hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                            ...
                                            <li className="flex items-center pt-2 pb-4 text-sm leading-3 tracking-normal text-gray-600 border-b border-gray-300 cursor-pointer xl:hidden hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                    ...
                                    <div className="hidden text-gray-700 close-m-menu" onclick="MenuHandler(this,false)">
                            ...
                            <div className="flex items-center justify-end w-full sm:w-auto sm:items-stretch sm:justify-start">
                                <div className="flex items-center">
                                    ...
                                    <h2 className="hidden pl-3 text-base font-bold leading-normal text-gray-700 sm:block">The North</h2>
                                </div>
                            </div>
                            <div className="flex">
                                <div className="hidden xl:flex md:mr-6 xl:mr-16">
                                    <a href="javascript: void(0)" className="flex items-center px-5 py-6 text-sm leading-5 text-gray-700 transition duration-150 ease-in-out hover:bg-gray-100 focus:bg-gray-100 focus:outline-none">
                                        <span className="mr-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-grid" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" />
                                                <rect x={4} y={4} width={6} height={6} rx={1} />
                                ...
                                <div className="items-center hidden xl:flex">
                                    <div className="relative my-2 md:mr-6">
                                        <button className="px-5 py-2 text-xs text-gray-600 transition duration-150 ease-in-out bg-gray-100 border border-gray-300 rounded focus:outline-none hover:bg-gray-300">Manage</button>
                                    </div>
                                    <div className="relative ml-6">
                                        <div className="relative flex items-center" onClick={() => setProfile(!profile)}>
                                            {profile && (
                                                <ul className="absolute top-0 right-0 w-40 p-2 mt-16 bg-white border-r rounded shadow ">
                                                    <li className="py-2 text-sm leading-3 tracking-normal text-gray-600 cursor-pointer hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                                        <div className="flex items-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-user" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                                <path stroke="none" d="M0 0h24v24H0z" />
                                            ...
                                            <div className="flex text-sm transition duration-150 ease-in-out border-2 border-transparent rounded-full cursor-pointer focus:outline-none focus:border-white">
