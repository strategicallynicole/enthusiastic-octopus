    ...
    return (
        <>
            <div className="w-full h-full bg-gray-200">
                {/* Code block starts */}
                <nav className="hidden w-full mx-auto bg-white shadow xl:block">
                    <div className="container flex items-center justify-between h-16 px-6 mx-auto lg:items-stretch">
                        <div className="flex items-center">
                            ...
                            <ul className="items-center hidden h-full pr-32 xl:flex">
                                ...
                                <li className="relative flex items-center h-full mx-10 text-sm tracking-normal cursor-pointer hover:text-indigo-700 text-gry-800" onClick={() => setProduct(!product)}>
                                    {product && (
                                ...
                                <li className="flex items-center h-full mr-10 text-sm tracking-normal cursor-pointer hover:text-indigo-700 text-gry-800">Performance</li>
                                <li className="relative flex items-center h-full text-sm tracking-normal text-gray-800 cursor-pointer hover:text-indigo-700" onClick={() => setDeliverables(!deliverables)}>
                                    {deliverables && (
                                        <ul className="absolute top-0 left-0 w-32 py-1 mt-16 -ml-4 bg-white rounded shadow">
                                            <li className="px-3 py-3 text-sm font-normal leading-3 tracking-normal text-gray-600 cursor-pointer hover:bg-indigo-700 hover:text-white">Landing Pages</li>
                                            <li className="px-3 py-3 text-sm font-normal leading-3 tracking-normal text-gray-600 cursor-pointer hover:bg-indigo-700 hover:text-white">Templates</li>
                        ...
                        <div className="items-center justify-end hidden h-full xl:flex">
                            <div className="flex items-center h-full">
                                <div className="flex items-center justify-end w-32 h-full pr-16 border-r" />
                                <div className="flex w-full h-full">
                                    <div className="flex items-center justify-center w-32 h-full text-gray-600 border-r">
                                        ...
                                        <div className="flex items-center justify-between w-full mt-6">
                                            <div className="flex items-center justify-between w-full">
                                                <div className="flex items-center">
                                                    ...
                                                    <p className="ml-3 text-base text-gray-800 md:text-base">The North</p>
                                                </div>
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        {product ? (
                                                            <div onClick={() => setProduct(!product)}>
                                                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-up" width={12} height={12} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                            ...
                                                            <div onClick={() => setProduct(!product)}>
                                                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-down" width={12} height={12} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                                    <polyline points="6 9 12 15 18 9" />
                                                                </svg>
                                                            </div>
