    ...
    return (
        <>
            <div className="w-full h-full bg-gray-200">
                {/* Code block starts */}
                <nav className="hidden w-full bg-gray-800 shadow xl:block">
                    <div className="container flex items-center justify-between h-16 px-6 mx-auto lg:items-stretch">
                        <div className="flex items-center">
                            <div className="flex items-center mr-10">
                                ...
                                <h3 className="hidden ml-3 text-base font-bold leading-tight tracking-normal text-white lg:block">The North</h3>
                            </div>
                            <ul className="items-center hidden h-full xl:flex">
                                <li className="flex items-center h-full text-sm tracking-normal text-indigo-700 transition duration-150 ease-in-out cursor-pointer">
                                    <span className="mr-2">
                                ...
                                <li className="flex items-center h-full mx-10 text-sm tracking-normal text-white transition duration-150 ease-in-out cursor-pointer hover:text-indigo-700">
                                    <span className="mr-2">
                                ...
                                <li className="flex items-center h-full mr-10 text-sm tracking-normal text-white transition duration-150 ease-in-out cursor-pointer hover:text-indigo-700">
                                    <span className="mr-2">
                                ...
                                <li className="flex items-center h-full text-sm tracking-normal text-white transition duration-150 ease-in-out cursor-pointer hover:text-indigo-700">
                                    <span className="mr-2">
                        ...
                        <div className="items-center justify-end hidden h-full xl:flex">
                            <div className="flex h-full">
                                <div className="flex items-center justify-center h-full px-6 text-gray-400 border-l border-gray-700">
                                    ...
                                    <svg onClick="searchHandler(this)" xmlns="http://www.w3.org/2000/svg" className="cursor-pointer icon icon-tabler icon-tabler-search" width={28} height={28} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" />
                                        <circle cx={10} cy={10} r={7} />
                                        <line x1={21} y1={21} x2={15} y2={15} />
                                    </svg>
                                </div>
                                <div className="flex items-center justify-center w-20 h-full text-gray-400 border-l border-r border-gray-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="cursor-pointer icon icon-tabler icon-tabler-messages" width={28} height={28} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" />
                                        <path d="M21 14l-3 -3h-7a1 1 0 0 1 -1 -1v-6a1 1 0 0 1 1 -1h9a1 1 0 0 1 1 1v10" />
                                        <path d="M14 15v2a1 1 0 0 1 -1 1h-7l-3 3v-10a1 1 0 0 1 1 -1h2" />
                                    </svg>
                                </div>
                                <div className="flex items-center justify-center w-20 h-full text-gray-400 border-r border-gray-700 cursor-pointer">
                                ...
                                <div className="relative flex items-center pl-8 cursor-pointer" onClick={() => setProfile(!profile)}>
                                    {profile && (
                                        <ul className="absolute top-0 left-0 w-40 p-2 mt-16 bg-white border-r rounded shadow ">
                                    ...
                                    <p className="ml-2 text-sm text-white">Jane Doe</p>
                                </div>
                            </div>
                        </div>
                        <div className="flex items-center xl:hidden">
                            <ul className="absolute top-0 left-0 right-0 hidden p-2 mt-16 bg-white border-r rounded shadow md:mt-16">
                                <li className="flex py-2 mt-2 text-sm leading-3 tracking-normal text-gray-600 cursor-pointer md:hidden hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                    <div className="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-grid" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" />
                                            <rect x={4} y={4} width={6} height={6} rx={1} />
                                ...
                                <li className="flex flex-col justify-center py-2 text-sm leading-3 tracking-normal text-gray-600 cursor-pointer md:hidden hover:text-indigo-700 focus:text-indigo-700 focus:outline-none" onClick="dropdownHandler(this)">
                                    <div className="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-puzzle" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" />
                                            <path d="M4 7h3a1 1 0 0 0 1 -1v-1a2 2 0 0 1 4 0v1a1 1 0 0 0 1 1h3a1 1 0 0 1 1 1v3a1 1 0 0 0 1 1h1a2 2 0 0 1 0 4h-1a1 1 0 0 0 -1 1v3a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-1a2 2 0 0 0 -4 0v1a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1h1a2 2 0 0 0 0 -4h-1a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1" />
                                ...
                                <li className="flex items-center py-2 text-sm leading-3 tracking-normal text-gray-600 cursor-pointer md:hidden hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-compass" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" />
                                        <polyline points="8 16 10 10 16 8 14 14 8 16" />
                                        <circle cx={12} cy={12} r={9} />
                                ...
                                <li className="flex flex-col justify-center pt-2 pb-4 text-sm leading-3 tracking-normal text-gray-600 border-b border-gray-300 cursor-pointer md:hidden hover:text-indigo-700 focus:text-indigo-700 focus:outline-none" onClick="dropdownHandler(this)">
                                    <div className="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-code" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" />
                                            <polyline points="7 8 3 12 7 16" />
                                ...
                                <li className="flex items-center py-2 mt-2 text-sm leading-3 tracking-normal text-gray-600 cursor-pointer hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                    <div className="flex items-center">
                                        <div className="flex w-12 text-sm transition duration-150 ease-in-out border-2 border-transparent rounded cursor-pointer focus:outline-none focus:border-white">
                                            <img className="object-cover w-10 h-10 rounded" src="https://tuk-cdn.s3.amazonaws.com/assets/components/horizontal_navigation/hn_1.png" alt="logo" />
                                        </div>
                                        <p className="ml-2 text-sm cursor-pointer">Jane Doe</p>
                ...
                {/* Navbar */}
                <nav>
                    <div className="fixed top-0 z-40 flex items-center justify-between w-full px-6 py-4 bg-gray-800 xl:hidden">
                        <div className="w-24">
                    ...
                    <div className={show ? "absolute w-full h-full transform -translate-x-0 z-40" : "absolute w-full h-full transform -translate-x-full z-40"} id="mobile-nav">
                        ...
                        <div className="fixed top-0 z-40 flex-col justify-between w-64 h-full pb-4 overflow-y-auto transition duration-150 ease-in-out bg-gray-800 shadow xl:hidden">
                                        ...
                                        <div className="flex items-center justify-between w-full mt-6">
                                            <div className="flex items-center justify-between w-full">
                                                <div className="flex items-center">
                                                    ...
                                                    <p className="ml-3 text-base text-white">The North</p>
                                                </div>
                                            ...
                                            <a className="cursor-pointer">
                                                <li className="pt-10 text-white">
                                                    <div className="flex items-center">
                                                        ...
                                                        <p className="ml-3 text-base text-indigo-700 xl:text-base">Dashboard</p>
                                                    </div>
                                                </li>
                                            </a>
                                            <a className="cursor-pointer">
                                                <li className="pt-8 text-white">
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex items-center">
                                                            <div className="w-6 h-6 text-white md:w-8 md:h-8">
                                                            ...
                                                            <p className="ml-3 text-base text-white xl:text-base">Products</p>
                                                        </div>
                                                    </div>
                                                </li>
                                            </a>
                                            <a className="cursor-pointer">
                                                <li className="pt-8 text-white">
                                                    <div className="flex items-center">
                                                        ...
                                                        <p className="ml-3 text-base text-white xl:text-base">Performance</p>
                                                    </div>
                                                </li>
                                            </a>
                                            <li className="pt-8 text-white cursor-pointer">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center">
                                                        ...
                                                        <p className="ml-3 text-base text-white xl:text-base">Deliverables</p>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                                        ...
                                        <div className="border-t border-gray-700">
                                            <div className="flex items-center justify-between w-full pt-1">
                                                <div className="flex items-center">
                                                    ...
                                                    <p className="ml-2 text-base leading-4 text-white ">Jane Doe</p>
                                                </div>
                                                <ul className="flex">
