    ...
    return (
     <>
                    ...
                    <div className={show ? "w-full h-full absolute z-40  transform  translate-x-0 " : "   w-full h-full absolute z-40  transform -translate-x-full"} id="mobile-nav">
                        <div className="absolute w-full h-full bg-gray-800 opacity-50 lg:hidden" onClick={() => setShow(!show)} />
                            ...
                            <div className="flex flex-col justify-between w-full h-full">
                                <div>
                                    <div className="flex items-center justify-between px-8">
                                        ...
                                        <div id="closeSideBar" className="flex items-center justify-center w-10 h-10" onClick={() => setShow(!show)}>
                                    ...
                                    <ul aria-orientation="vertical" className="py-6 ">
                                        <li className="pt-5 pb-4 pl-6 text-sm leading-3 tracking-normal text-white text-indigo-700 cursor-pointer focus:text-indigo-700 focus:outline-none">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ml-2 text-base xl:text-base md:text-2xl">Dashboard</span>
                                            </div>
                                        </li>
                                        <li className="py-2 pl-6 mt-4 mb-4 text-sm leading-3 tracking-normal text-gray-600 cursor-pointer hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ml-2 text-base xl:text-base md:text-2xl">Products</span>
                                            </div>
                                        </li>
                                        <li className="py-2 pl-6 mb-4 text-sm leading-3 tracking-normal text-gray-600 cursor-pointer hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ml-2 text-base xl:text-base md:text-2xl">Performance</span>
                                            </div>
                                        </li>
                                        <li className="py-2 pl-6 text-sm leading-3 tracking-normal text-gray-600 cursor-pointer hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ml-2 text-base xl:text-base md:text-2xl">Deliverables</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                <div className="w-full">
                                    <div className="flex justify-center w-full px-6 mb-4">
                                        <div className="relative w-full">
                                            ...
                                            <input className="w-full py-2 pl-10 text-sm text-gray-500 bg-gray-200 rounded focus:outline-none" type="text" placeholder="Search" />
                                        </div>
                                    </div>
                                    <div className="border-t border-gray-300">
                                        <div className="flex items-center justify-between w-full px-6 pt-1">
                                            <div className="flex items-center">
                                                ...
                                                <p className="ml-2 text-base leading-4 text-gray-800 md:text-xl">Jane Doe</p>
                                            </div>
                                            <ul className="flex">
